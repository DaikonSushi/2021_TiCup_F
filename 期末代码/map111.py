...
def track_line():
    ...
    while True:
        ...
        '''
        # 停止条件
        if turn_count == 10 or turn_count == 25 or turn_count == 54 or turn_count == 16 or turn_count == 65:
            runrun(0.7)
            time.sleep(0.01)
            car.Car_Stop()
            time.sleep(1)
            ...
            turn_count += 1
            continue
        elif turn_count == 60 or turn_count == 36:
            runrun(0.7)
            time.sleep(0.01)
            car.Car_Stop()
            time.sleep(1)
...
try:
    ...
    if(map_num==1):
        ...
        all_directions = [l,l,r,r,l,r,f,r,f,l,r,r,br,l,l,r,r,l,f,bl,r,r,r,l,f,br,l,r,r,bl,l,l,r,f,br,r,l,l,br,l,f,r,l,l,bl,r,r,l,l,r,br,l,l,l,r,f,l,l,r,l,l,r,r]   #map2
    elif(map_num==3):
